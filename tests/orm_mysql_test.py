...
db = DB("mysql+pymysql://root:LWsVjzKIO0FTdA==@127.0.0.1:3306/rmf-test1?charset=utf8mb4")

db.insert(filename="test.jpg", filepath="http://127.0.0.1/test.jpg", filepath_samll="http://127.0.0.1/test_small.jpg",
          color=random_list(4), glcm=random_list(4), lbp=random_list(4), vgg=random_list(4), vit=random_list(4))
